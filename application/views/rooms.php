            ...
            <?php foreach ($kamar as $room) { ?>
                <article class="room" id="room">
                    ...
                    <div class="content-botton">
                        <a href="<?php echo base_url('clogin/formlogin'); ?>"><button type="button">Rp.<?php $harga=$room->harga; $harga_formatted = number_format($harga, 0, ',', '.'); echo $harga_formatted ?>/Night</button></a>                    
                    </div>
                </article>
            <?php } ?>
            </div>
