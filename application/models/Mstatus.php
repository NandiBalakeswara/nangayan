...
class Mstatus extends CI_Model
{
    ...
    {
        $this->db->select('tbpengguna.nama_lengkap, tbpengguna.username, tbpengguna.nomor_hp, tblayanan.nama_layanan, tblayanan.harga_layanan, tbkamar.jenis_kamar, tbkamar.foto, tbpemesanan.waktu_masuk, tbpemesanan.waktu_keluar, tbkamar.harga, tbpemesanan.nomor_kamar, tbpemesanan.status_pemesanan, tbpemesanan.status_pembayaran , DATEDIFF(waktu_keluar, waktu_masuk) AS jumlah_hari');
